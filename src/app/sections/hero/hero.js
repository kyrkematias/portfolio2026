    ...
    <section className="relative bg-[#0e0f1a] text-white min-h-screen flex items-center justify-center px-6 md:px-20 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          Desarrollador Frontend & Especialista SEO
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-tight text-white"
        >
          DESARROLLO WEB & <br />
        ...
        >
          Soy <span className="text-white font-medium">Martín</span>. Creo interfaces modernas, ultrarrápidas y optimizadas para motores de búsqueda, diseñadas para conectar con tu audiencia y potenciar tu negocio digital.
        </motion.p>
        ...
        >
          <div className="flex items-center justify-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 backdrop-blur-sm">
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-white uppercase tracking-wider">Frontend</p>
              <p className="text-[11px] text-gray-400">Next.js, React & Tailwind</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 backdrop-blur-sm">
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-white uppercase tracking-wider">SEO Técnico</p>
              <p className="text-[11px] text-gray-400">Posicionamiento & Speed</p>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-3 p-4 rounded-xl bg-white/5 border border-white/5 backdrop-blur-sm">
            ...
            <div className="text-left">
              <p className="text-xs font-bold text-white uppercase tracking-wider">Rendimiento</p>
              <p className="text-[11px] text-gray-400">Sitios 100% Optimizados</p>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      >
        <span className="text-[10px] font-mono tracking-widest uppercase text-gray-500 group-hover:text-gray-300">Descubrir</span>
