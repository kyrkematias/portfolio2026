...
export default async function BlogPostEn({ params }) {
  ...
  const articleUrl = `https://www.martinmatias.com.ar/en/blog/${slug}`;
  ...
  const postSchemaEn = [
    {
      ...
      "articleSection": post.category || "Web Development & SEO",
    },
    {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      "itemListElement": [
        {
          ...
          "position": 1,
          "name": "Home",
          "item": "https://www.martinmatias.com.ar/en",
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": "Blog",
          "item": "https://www.martinmatias.com.ar/en/blog",
        },
        {
          "@type": "ListItem",
          "position": 3,
